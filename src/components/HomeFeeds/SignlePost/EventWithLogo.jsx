...
import logo from '../../../assets/reply/over.png'
import {
    FaAngleDown,
    FaEllipsisH,
    FaExclamationCircle,
                        ...
                        <div className=" relative">
                            ...
                            <div className="">
                                ...
                                <div className="bg-[#000000BF] z-10 absolute top-64 border-b-md rounded-lg h-[170px] w-full">
                                    ...
                                    <div className="count ms-12 items-center justify-between me-2 flex">
                                        {/* logo part  */}
                                        <div className="dates">
                                            <img src={logo} className="w-[112px] " alt="" />
                                        </div>
                                        {/* 2nd block  */}
