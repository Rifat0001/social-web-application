...
import girl from '../../../../assets/CategorySection/girloncar.png'
...
const FirstCategorypost = () => {
    return (
        <div className='first-outer-box  pt-4'>
            <div className="main-section-start-here w-2/3 mx-auto">
                <div className="top-outer-box flex items-center ps-4">
                    <p className='text-white'>Story added to trip category</p>
                </div>
            ...
            <div className="ms-12">
                ...
                <div className="transform ps-16 second-comment-category transition cursor-pointer  ml-10 relative flex items-center px-6 py-4 text-white rounded mb-1 flex-col md:flex-row space-y-4 md:space-y-0">
                    {/* <!-- Line that connecting the box with the vertical line --> */}
...
export default FirstCategorypost;