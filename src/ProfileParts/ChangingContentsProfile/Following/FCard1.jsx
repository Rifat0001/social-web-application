import follower from '../../../assets/LikeSections/sara.png'
    ...
    return (
        <div className="follow-container-card items-center ps-6 flex gap-4">
            ...
            <div className="next-part flex flex-col gap-1">
                <p className='text-white'>Sara Raza</p>
                <p className='text-white'><span className='profile-user'>@Sister</span> (Pending)</p>
                ...
                <button className="delete-follow flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
                        <path d="M7.95 7.95L2 2M7.95 2L2 7.95" stroke="#F8F8F8" stroke-width="2.09524" stroke-linecap="round" stroke-linejoin="round" />
                    </svg> <p className='text-white'>Delete</p>
                </button>
            </div>
        </div>
    );
