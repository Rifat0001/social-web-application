...
const FirstPost = () => {
    return (
        <section>
            <div className="mx-8 relative pt-10 text-white ">
                <div className="pb-5 first-top ">
                    ...
                    <div className="space-y-[40px]">
                        ...
                        <div className="text-end">
                            ...
                            <div className="ps-10 flex justify-end">
                                <div className="first-divider bg-[#EC46E5] w-full h-[1px]"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="">
                    ...
                    <div className="transform ps-16 second-comment-first transition cursor-pointer  ml-10 relative flex items-center px-6 py-4 text-white rounded mb-1 flex-col md:flex-row space-y-4 md:space-y-0">
                        {/* <!-- Line that connecting the box with the vertical line --> */}
                        <div className="w-14 h-0.5 bg-[#00E7FC] absolute top-8 left-[2px] z-0"></div>
            ...
            <div className="mx-8">
                <Reply></Reply>
                <div className=" flex ">
                    <div className=" mx-3 my-3 bg-[#00E7FC] w-[100%] h-[1px]"></div>
                </div>
